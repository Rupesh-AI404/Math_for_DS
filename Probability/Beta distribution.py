...
print(f"99% confidence interval = [{beta.ppf(0.001, a2, b2):.3f}, {beta.ppf(0.999, a2, b2):.3f}]")
print(f"99.9% confidence interval = [{beta.ppf(0.0001, a2, b2):.3f}, {beta.ppf(0.9999, a2, b2):.3f}]")

...
print(f"LOO R^2 on LOO predictions: {r2_score(y, y_pred_loo[loo.get_n_splits()//2]):.3f}")
print(f"LOO R^2 on CV predictions: {r2_score(y, y_pred_loo[loo.get_n_splits()//2]):.3f}")
print(f"LOO R^2 on CV predictions (LOO): {r2_score(y, y_pred_loo):.3f}")
